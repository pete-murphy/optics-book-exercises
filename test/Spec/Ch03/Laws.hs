...
prop_unlawful2_getSet = getSet ((,) <$> genString <*> genString) unlawful2

prop_unlawful2_setSet :: Property
prop_unlawful2_setSet = setSet ((,) <$> genString <*> genString) genString unlawful2

prop_unlawful2_setGet :: Property
prop_unlawful2_setGet = setGet ((,) <$> genString <*> genString) genString unlawful2
-- Fails
